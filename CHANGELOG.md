...
### Released
- Released **clinical-ai-disclosure-landing** publicly as a reviewable operating system for healthcare operations.
...
### Shipped
- Cut the first coherent internal version of **clinical-ai-disclosure-landing** with stable domain objects, review surfaces, and decision outputs.
